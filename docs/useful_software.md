...
**Why it's useful:**
Working with infoLayer files (farmlands, fields, soil maps) and densityMap files (height, ground, foliage) is much easier when you can edit them as PNG images in tools like Photoshop or GIMP, then convert them back to the game's native format.
