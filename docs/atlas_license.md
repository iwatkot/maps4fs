# Atlas FS License and Ownership
...
Maps created using the Maps4FS tool are also subject to the [Maps4FS License](license-info.md) (CC BY-NC 4.0). Authors must comply with both:
...
📄 **Full License**: [Maps4FS License](license-info.md)
...
- **Maps4FS License**: See [license-info.md](license-info.md)

## 📚 Related Documentation

- [Atlas FS Terms of Use](atlas_terms.md) - User responsibilities and legal consequences
