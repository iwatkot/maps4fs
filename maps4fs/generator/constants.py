...
class Parameters:
    ...
    # ---- Organic plant generation tuning -------------------------------
    PLANT_BINARY_MASK_VALUE = 255

    PLANT_MASK_EROSION_KERNEL_SIZE = 3
    PLANT_MASK_EROSION_ITERATIONS = 1

    PLANT_EDGE_BUFFER_MIN = 2.0
    PLANT_EDGE_BUFFER_MAX = 6.0
    PLANT_EDGE_BUFFER_DIVISOR = 320.0

    PLANT_EDGE_JITTER_COARSE_SIGMA_MIN = 3.0
    PLANT_EDGE_JITTER_COARSE_SIGMA_DIVISOR = 170.0
    PLANT_EDGE_JITTER_FINE_SIGMA_MIN = 1.5
    PLANT_EDGE_JITTER_FINE_SIGMA_DIVISOR = 480.0
    PLANT_EDGE_JITTER_COARSE_WEIGHT = 0.7
    PLANT_EDGE_JITTER_FINE_WEIGHT = 0.3
    PLANT_EDGE_JITTER_NORMALIZE_ALPHA = -1.0
    PLANT_EDGE_JITTER_NORMALIZE_BETA = 1.2
    PLANT_EDGE_BUFFER_CLIP_MIN = 0.9
    PLANT_EDGE_BUFFER_CLIP_MAX_FACTOR = 2.4

    PLANT_COVERAGE_MIN = 0.14
    PLANT_COVERAGE_MAX = 0.52
    PLANT_COVERAGE_BASE = 0.14
    PLANT_COVERAGE_COMPLEXITY_SCALE = 0.34

    PLANT_COMPONENT_MIN_PIXELS = 24
    PLANT_SMOOTH_KERNEL_SIZE = 3
    PLANT_SMOOTH_ITERATIONS = 1

    PLANT_COMPONENT_LARGE_SIGMA_MIN = 3.0
    PLANT_COMPONENT_LARGE_SIGMA_DIVISOR = 80.0
    PLANT_COMPONENT_SMALL_SIGMA_MIN = 1.0
    PLANT_COMPONENT_SMALL_SIGMA_DIVISOR = 260.0
    PLANT_SELECTOR_SIGMA_MIN = 1.0
    PLANT_SELECTOR_SIGMA_DIVISOR = 170.0
    PLANT_COMPONENT_LARGE_NOISE_WEIGHT = 0.76
    PLANT_COMPONENT_SMALL_NOISE_WEIGHT = 0.24

    PLANT_MICRO_SPRINKLE_RATIO_MIN = 0.0025
    PLANT_MICRO_SPRINKLE_RATIO_MAX = 0.012
    PLANT_MICRO_SPRINKLE_RATIO_DIVISOR = 55.0
    PLANT_MICRO_CLUMP_KERNEL_SIZE = 2
    PLANT_MICRO_CLUMP_ITERATIONS = 1
